                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Creación de Conductores</h5>
                                            <span>Crear y buscar conductores</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Busca o crea conductores</h5>
                                                        <span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>
                                                        <a class="btn btn-warning btn-round waves-effect waves-light float-end" href="tb_infoconductores.php">Visualizar Tabla</a>
                                                    </div>
                                                    <style>
                                                        .suggestions {
                                                    ...
                                                    <div class="card-block">
                                                        <form id="filtro-form" action="controlador/agregar_infoconductor.php" method="post">
                                                            <div class="row">
                                                                <div class="col-sm-12 col-xl-6 m-b-30">
                                                                    <h4 class="sub-title text-center">Nombre del Conductor</h4>
                                                                    <input class="form-control col-sm-12" name="nombre_conductor" id="Conductornombre" required>
                                                                    <div id="suggestions" class="suggestions"></div>
                                                                </div>
                                                                <div class="col-sm-12 col-xl-6 m-b-30">
                                                                    <h4 class="sub-title text-center">Correo</h4>
                                                                    <input class="form-control col-sm-12" name="correo" id="Conductorusuario" required>
                                                                </div>
                                                                <div class="col-sm-12 col-xl-6 m-b-30">
                                                                    <h4 class="sub-title text-center">Telefono</h4>
                                                                    <input class="form-control col-sm-12" name="telefono" id="telefono" required>
                                                                </div>
                                                                <div class="col-sm-12 col-xl-6 m-b-30">
                                                                    <h4 class="sub-title text-center">Número de Placa</h4>
                                                                    <input class="form-control col-sm-12" name="placa" id="placa" required>
                                                                </div>
                                                                <div class="col-sm-12 col-xl-12 m-b-30">
                                                                    <h4 class="sub-title text-center">Cuidad</h4>
                                                                    <select class="form-select form-control form-control-warning" name="ciudad" id="ciudad" required>
                                                                        <option value=""></option>
                                                                ...
                                                                <div class="col-sm-12 col-xl-12 m-b-30">
                                                                    <button type="submit" class="btn btn-warning btn-round waves-effect waves-light form-control">Agregar Conductor</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                        <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                                                        <script>
                                                            $(document).ready(function(){
                                                                $('#Conductornombre').on('input', function() {
                                                                    let query = $(this).val();
                                                                    if (query.length > 2) {
                                                                        $.ajax({
                                                                            ...
                                                                            success: function(data) {
                                                                                ...
                                                                                results.forEach(item => {
                                                                                    let suggestionItem = $('<div class="suggestion-item"></div>').text(item.Conductornombre);
                                                                                    suggestionItem.on('click', function() {
                                                                                        $('#Conductornombre').val(item.Conductornombre);
                                                                                        $('#Conductorusuario').val(item.Conductorusuario);
...
?>
        <script language="JavaScript" type="text/javascript">
            Swal.fire({
                title: 'Éxito',
                text: '¡Coductor Agregado Correctamete!',
                icon: 'success',
                backdrop: true,
                ...
                didClose: () => {
                  window.location.href = 'tb_infoconductores.php';
                }
            });
        </script>
<?php
